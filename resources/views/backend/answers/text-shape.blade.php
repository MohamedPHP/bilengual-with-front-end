                                                                    ...
                                                                    <li class="answer">
                                                                        <div class="row" data-qid = "{{ $question->id }}" data-aid="{{ $answer->id }}">
                                                                            ...
                                                                            <div class="col-md-4 pull-right">
                                                                                ...
                                                                                <a href="{{ route('answer.question-text.answer-shape.delete', ['id' => $answer->id]) }}" class="btn btn-sm btn-danger">Delete</a>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                @endforeach
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" id="Answers_Modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('answers.question-text.answer-shape.create') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" id="Edit_Single_Answer_Modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('answer.question-text.answer-shape.update') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
