                                    ...
                                    @foreach ($questions as $q)
                                        <tr data-questionid="{{ $q->id }}" data-roundid="{{ $q->round->id }}">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('quistions.questions-shape.answers-text.delete', ['id' => $q->id]) }}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" id="Add_Shape_Question_Modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('quistions.questions-shape.answers-text.create') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" id="Edit_Question_Modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('quistions.questions-shape.answers-text.update') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
