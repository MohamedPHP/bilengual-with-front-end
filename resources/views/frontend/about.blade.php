...
<div class="header">
	<div class="container rel text-left">
		<a class="brand brand-color" href="{{url('/')}}">APPI</a>
...
<div class="carousel">
	<div class="carousel-item" style="background-image: url('frontend/img/slide-1.jpg')">

	</div>
	<div class="carousel-item" style="background-image: url('frontend/img/slide-3.jpg')">

	</div>
	<div class="carousel-item" style="background-image: url('frontend/img/slide-2.jpg')">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 text-center">
				<img src="{{asset('frontend/img/ceo.jpg')}}" width="90%">
