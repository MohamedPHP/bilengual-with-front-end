...
<body>
	...
	<div class="level level-img-right">
		...
		<div class="container xs-mb-30">
			<img class=img-right-sprite src="{{asset('frontend/img/v2/iphone-bg-lg.min.png')}}" alt>
		...
		<div class="visible-xs xs-mw xs-mb-40">
			<img src="{{asset('frontend/img/v2/iphone-mobile.min.png')}}" alt>
		</div>
	...
	<p class="fmenu">
		<a href="{{ url('/') }}">HOME</a> | <a href="{{ url('/about') }}">ABOUT</a>
	</p>
